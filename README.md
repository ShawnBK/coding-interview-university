...
- [x] [ABC: Always Be Coding](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4)
    - Always Be coding. Not just practice, but focussed practice
    - Master a Language
    - Learn The Complexities
    - Reinvent the wheel ie Reimplement basic structures and algorithms
    - Practice on competitive programs
